...
<title>Salas · Palacio de Festivales</title>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="menuPrincipal">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item"><a class="nav-link active" href="sala.php"><i class="bi bi-building"></i> Salas</a></li>
...
<div class="container py-5">
  ...
  <div class="panel">
    <div class="panel-titulo">
      <span><i class="bi bi-building"></i> Salas del Palacio</span>
      <button class="btn btn-oro btn-sm" data-bs-toggle="modal" data-bs-target="#modalSala" onclick="prepararNuevaSala()">
        <i class="bi bi-plus-lg"></i> Nueva sala
      </button>
    </div>

    <div id="alertaSala"></div>
...
<div class="modal fade" id="modalSala" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="formSala" novalidate>
        <div class="modal-header">
          <h5 class="modal-title texto-oro" id="tituloModalSala">Nueva sala</h5>
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="salaNombre" placeholder="Ej: Auditorio Principal" required minlength="3">
            <div class="invalid-feedback">Ingresa un nombre de al menos 3 caracteres.</div>
          </div>

          <div class="mb-3">
            <label class="form-label">Capacidad (personas)</label>
            <input type="number" class="form-control" id="salaCapacidad" min="1" placeholder="Ej: 500" required>
            <div class="invalid-feedback">Ingresa una capacidad válida mayor a 0.</div>
          </div>

          <div class="mb-3">
            <label class="form-label">Ubicación</label>
            <input type="text" class="form-control" id="salaUbicacion" placeholder="Ej: Planta baja">
          </div>

          <div class="mb-3">
            <label class="form-label">Descripción</label>
            <textarea class="form-control" id="salaDescripcion" rows="2" placeholder="Detalles de la sala..."></textarea>
          </div>

          <div class="mb-1">
            <label class="form-label">Estado</label>
            <select class="form-select" id="salaEstado">
